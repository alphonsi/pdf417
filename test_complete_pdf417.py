#!/usr/bin/env python3
"""
Complete PDF417 Test Script

This script tests both encoding and decoding of PDF417 barcodes.
"""
...
def main():
    ...
    print(f"\nGenerated file: {image_path}")
    print("You can open this file to view the barcode and test with phone apps.")
